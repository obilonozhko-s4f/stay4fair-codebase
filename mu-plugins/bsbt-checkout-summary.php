...
function bsbt_checkout_summary_render() {
    ...
    <div class="bsbt-checkout-summary"
        ...
        <div class="bsbt-checkout-summary-card">
            ...
            <!-- Check-in + Check-out в одну строку -->
            ...
            <!-- Cancellation под Total, обычным текстом -->
            ...
            <p class="bsbt-summary-note">
                ...
                No payment is required at this step. Your booking is a request and will be confirmed within 24 hours.
            </p>
        </div>
    </div>
    <script>
